            ...
            <main className="flex-1">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="space-y-8">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black title-gradient" style={{ lineHeight: '1.2' }}>
                                    Revolutionizing DeFi with AI-Powered Agent Swarms on Injective
                                </h1>
                                <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
                                    Simplify your DeFi experience with the power of Multi-Agent Systems (MAS) on Injective
                                </p>
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <Button
                                        size="lg"
                                        onClick={() => handleExternalLink('https://t.me/injecthivedemo_bot')}
                                    ...
                                    <Button
                                        size="lg"
                                        variant="outline"
                                        onClick={() => handleExternalLink('https://injecthive-ai.gitbook.io')}
                ...
                <section className="py-24 space-y-12">
                    <div className="container text-center space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Seamlessly connected with the leading platforms and protocols in the Injective ecosystem
                        </p>
                    </div>
                    <LogoCarousel />
                </section>
                ...
                <section id="pricing" className="container py-24 space-y-12">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            InjectHive is and will always be open source! We strongly encourage users to self-host their own instance.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                href: "https://github.com/nicoware-dev/injecthive",
                                featured: true
                            },
                            {
                                title: "Free Tier",
                ...
                <section id="opensource" className="relative py-24">
                    ...
                    <div className="container relative space-y-12">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            InjectHive is an open-source initiative. We invite developers and contributors to help us expand the MAS ecosystem and redefine DeFi automation together.
                            </p>
                        </div>
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <Button
                                ...
                                onClick={() => handleExternalLink('https://github.com/nicoware-dev/injecthive')}
                            >
                            ...
                            <Button
                                ...
                                size="lg"
                                className="border-[#27272A] hover:bg-[#7f00ff]/10 hover:border-[#7f00ff]/50 hover:text-[#7f00ff] transition-all duration-300 w-full sm:w-auto"
                                onClick={() => handleExternalLink('https://discord.gg/xv7bcRpgUw')}
                            >
                ...
                <section className="container py-24 space-y-12">
                    ...
                    <div className="flex justify-center gap-8">
                        <a href="https://x.com/InjectHiveAgent" target="_blank" rel="noopener noreferrer" className="group">
                    ...
                    <div className="container relative space-y-12">
                        ...
                        <div className="flex flex-col items-center gap-8">
                            ...
                            <Button
                                ...
                                onClick={() => handleExternalLink('https://t.me/injecthivesales_bot')}
                            >
            ...
            <footer className="border-t border-white/[0.08] bg-background">
                <div className="container py-12">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        <div className="space-y-4">
                            <div className="flex flex-col items-center text-center">
                                <div className="flex items-center gap-2">
                                    <img src={logo} alt="InjectHive Logo" className="h-6 w-6" />
                                    <h3 className="text-lg font-semibold text-white">InjectHive</h3>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col items-center gap-4 mt-4">
                                <a
                                    href="https://t.me/+PRy4jA7qCnZhNjIx"
                                ...
                                <a
                                    href="https://discord.gg/xv7bcRpgUw"
                                    className="w-6 h-6 flex items-center justify-center"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                ...
                                <a
                                    href="https://linktr.ee/InjectHive"
                                    className="w-6 h-6 flex items-center justify-center"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                    ...
                    <div className="mt-12 pt-8 border-t border-white/[0.08] text-center text-sm text-muted-foreground">
                        © 2025 InjectHive. All rights reserved.
                    </div>
                </div>
            </footer>
        </div>
