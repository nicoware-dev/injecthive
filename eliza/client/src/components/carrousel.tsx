...
import injective from "../assets/logos-ext/injective.svg";
import helix from "../assets/logos-ext/helix.svg";
import hydro from "../assets/logos-ext/hydro.svg";
import dojoswap from "../assets/logos-ext/dojoswap.svg";
...
const logos = [
  ...
  { id: "injective", src: injective, alt: "Injective" },
  { id: "helix", src: helix, alt: "Helix" },
  { id: "hydro", src: hydro, alt: "Hydro" },
  { id: "dojoswap", src: dojoswap, alt: "DojoSwap" },
