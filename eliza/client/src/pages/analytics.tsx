...
const protocolData = [
    { id: 'helix', name: 'Helix', value: 96.73 },
    { id: 'hydro', name: 'Hydro', value: 89.34 },
    { id: 'injective-staking', name: 'Injective Staking', value: 78.68 },
    { id: 'dojoswap', name: 'DojoSwap', value: 70.48 }
];
