...
import * as CoinGeckoModule from "../../../src/actions/coingecko/module";
import * as DefiLlamaModule from "../../../src/actions/defillama/module";
...
export class InjectiveGrpcClient extends InjectiveGrpcBase {
    ...
    // CoinGecko endpoints
    public getTokenPrice = CoinGeckoModule.getTokenPrice;
    public getMultipleTokenPrices = CoinGeckoModule.getMultipleTokenPrices;
    
    // DefiLlama endpoints
    public getInjectiveTVL = DefiLlamaModule.getInjectiveTVL;
    public getProtocolByName = DefiLlamaModule.getProtocolByName;
    public getInjectiveYieldPools = DefiLlamaModule.getInjectiveYieldPools;
    public getTopInjectiveProtocols = DefiLlamaModule.getTopInjectiveProtocols;
}
